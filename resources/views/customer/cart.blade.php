...
<!-- Mirrored from yevgenysim-turkey.github.io/shopper/shopping-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Oct 2023 14:37:10 GMT -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-md-7">
                <form method="post" action="/home/cart/update">
                    @csrf
                <!-- List group -->
...
{{--                        @dump(session('shopping_cart'))--}}
{{--                        <?php--}}
{{--                                $ids = array_keys($obj); // Extract the IDs--}}
...
{{--                                ?>--}}
                        ...
                        <div class="row align-items-center">
                            <div class="col-3">
                        <div hidden data-id="{{$obj['id']}}">{{$obj['id']}}</div>
                                <!-- Image -->
                                <a href="/home/product/detail/{{$obj['id']}}">
                            ...
                            <div class="col">
                                ...
                                <div class="d-flex mb-2 fw-bold">
                                    <a class="text-body" href="/home/product/detail/{{$obj['id']}}">{{$obj['product_name']}}</a> <span class="ms-auto">Đơn giá: {{$obj['product_price']}}đ</span>
                                </div>

                                <!--Footer -->
                                <div class="d-flex align-items-center">
                                    <input type="hidden" name="product_id" value="{{ $obj['id'] }}">
                                    <span>Q.ty: <input type="number" min="1" max="{{$obj['product_quantity']}}" value="{{$obj['quantity']}}" name ='product_quantity' class = "cart_update quantity" id="quantity"></span>
                                    <!-- Remove -->
...
{{--                                @dump(session('shopping_cart'))--}}
                ...
                <!-- Button -->
                <a class="btn w-100 btn-dark mb-2" href="/home/checkout">Proceed to Checkout</a>

                <!-- Link -->
                <a class="btn btn-link btn-sm px-0 text-body" href="/home/product/all">
...
{{--                product_quantity: ele.parents("span").find(".quantity").val()--}}
{{--            },--}}
