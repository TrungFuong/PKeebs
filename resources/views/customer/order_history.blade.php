...
<!-- Mirrored from yevgenysim-turkey.github.io/shopper/account-orders.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Oct 2023 14:38:05 GMT -->
                ...
                <div class="card card-lg mb-5 border">
                            ...
                            <div class="card-body bg-light">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-lg-3">
                                        ...
                                        <!-- Heading -->
                                        <h6 class="heading-xxxs text-muted">Created at: </h6>
                    ...
                    <div class="card-footer">
                        <div class="row align-items-center">
                                    <div class="col-6">
                                        <!-- Button -->
                                        <a class="btn btn-sm w-100 btn-outline-dark" href="/home/order/{{$obj->id}}">
                                            Order Details
                                        </a>
                                    ...
                                    <div class="col-6">
                                        <!-- Button -->
                                        <a class="btn btn-sm w-100 btn-outline-danger " href="/home/order/cancel/{{$obj->id}}">
                                            Cancel Order
                                        </a>
                                    </div>
                        </div>
