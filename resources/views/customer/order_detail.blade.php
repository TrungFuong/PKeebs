...
<!-- Mirrored from yevgenysim-turkey.github.io/shopper/account-order.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Oct 2023 14:38:05 GMT -->
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            ...
                                            <p class="mb-4 fs-sm fw-bold">
                                                <a class="text-body" href="/home/product/{{ $obj->product_id }}">{{ $obj->product_name }}</a> <br>
                                                <span class="text-muted">{{ $obj->product_price }}</span>
                                            </p>
                                            <p class="mb-4 fs-sm fw-bold">
                                                <span class="text-muted">Q.ty: {{ $obj->product_quantity }}</span>
                                            </p>
                                        </div>
                                    </div>
                                </li>
