...
<!-- Mirrored from yevgenysim-turkey.github.io//shopper/product-images-stacked.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Oct 2023 14:38:04 GMT -->
            ...
            <div class="col-12">
                ...
                <ol class="breadcrumb mb-0 fs-xs text-gray-400">
                    <li class="breadcrumb-item">
                        <a class="text-gray-400" href="/home">Home</a>
                    </li>
                    <li class="breadcrumb-item">
                        <a class="text-gray-400" href="/home/category/{{$product->category->category_name}}">{{$product->category->category_name}}</a>
                    </li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <!-- Image -->
                        <a class="d-block mb-4" href="#" data-bigpicture='{ "imgSrc": "/shopper/assets/img/products/product-157.jpg"}'>
                            <img class="img-fluid" src="/image/{{$product -> product_image}}" alt="...">
                        </a>
                    </div>
                        ...
                        <div class="position-sticky" style="top: 62px;">
                            ...
                            <div class="row mb-1">
                                <div class="col">
                                    ...
                                    <!-- Preheading -->
                                        <a class="text-muted" href="/home/category/{{$product->category->category_name}}">{{$product->category->category_name}}</a>
                            ...
                            <!-- Price -->
                            <div class="mb-7">
                                <span class="ms-1 fs-5 fw-bolder">{{$product->product_price}} đ</span>
                            </div>

                            <!-- Form -->
                            <form class="mb-9" action="/home/cart/add/{{$product->id}}" method="post">
                                @csrf
                                <div class="form-group">
                                    ...
                                    <div class="row gx-5 mb-7">
                                        ...
                                        <div>
                                            ...
                                            <br/>
{{--                                            @dump($obj)--}}
{{--                                            <input type="number" placeholder="1x" name="product_quantity" disabled value="1" >--}}
                                            <span>{{$product->product_quantity}} có sẵn</span>
                                        </div>
...
<!-- Mirrored from yevgenysim-turkey.github.io//shopper/product-images-stacked.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Oct 2023 14:38:05 GMT -->
</html>
