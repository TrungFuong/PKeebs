...
<!-- Mirrored from yevgenysim-turkey.github.io/shopper/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Oct 2023 14:36:33 GMT -->
...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="/shopper/assets/favicon/favicon.ico" type="image/x-icon" />

    <!-- Libs CSS -->
    <link rel="stylesheet" href="/shopper/assets/css/libs.bundle.css" />

    <!-- Theme CSS -->
    <link rel="stylesheet" href="/shopper/assets/css/theme.bundle.css" />

    <!-- Title -->
    <title>Phương Keyboards</title>
</head>
<body>
        ...
        <div class="modal-content">
            ...
            <div class="row gx-0">
                <div class="col-12 col-lg-5">
                    ...
                    <!-- Image -->
                    <img class="img-fluid" src="shopper/assets/img/covers/cover-25.jpg" alt="...">
...
<div class="modal fade" id="modalNewsletterVertical" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <!-- Body -->
            <div class="modal-body mt-2 me-2 ms-2 py-10 bg-cover text-center text-white" style="background-image: url("shopper/assets/img/covers/cover-26.jpg");">
            ...
            <div class="container-fluid px-xl-0">
                <div class="row align-items-center mx-xl-0">
                    <div class="col-12 col-lg-6 col-xl-5 py-4 py-xl-0 px-xl-0">
                        ...
                        <!-- Image -->
                        <img class="img-fluid" src="shopper/assets/img/products/product-7.jpg" alt="...">
                            ...
                            <div class="form-group">
                                ...
                                <div class="mb-8 ms-n1">
                                    <div class="form-check form-check-inline form-check-img">
                                        <input type="radio" class="form-check-input" id="modalProductColorOne" name="modalProductColor" data-toggle="form-caption" data-target="#modalProductColorCaption" value="White" style="background-image: url(shopper/assets/img/products/product-7.jpg);" checked>
                                    </div>
                                    <div class="form-check form-check-inline form-check-img">
                                        <input type="radio" class="form-check-input" id="modalProductColorTwo" name="modalProductColor" data-toggle="form-caption" data-target="#modalProductColorCaption" value="Black" style="background-image: url(shopper/assets/img/products/product-49.jpg);">
                                    </div>
                                </div>
    ...
    <div class="offcanvas-body border-top fs-sm">
        ...
        <div class="row align-items-center position-relative mb-5">
            <div class="col-4 col-md-3">
                ...
                <!-- Image -->
                <img class="img-fluid" src="shopper/assets/img/products/product-5.jpg" alt="...">
        ...
        <div class="row align-items-center position-relative mb-5">
            <div class="col-4 col-md-3">
                ...
                <!-- Image -->
                <img class="img-fluid" src="shopper/assets/img/products/product-6.jpg" alt="...">
        ...
        <div class="row align-items-center position-relative mb-5">
            <div class="col-4 col-md-3">
                ...
                <!-- Image -->
                <img class="img-fluid" src="shopper/assets/img/products/product-8.jpg" alt="...">
        ...
        <div class="row align-items-center position-relative mb-5">
            <div class="col-4 col-md-3">
                ...
                <!-- Image -->
                <img class="img-fluid" src="shopper/assets/img/products/product-9.jpg" alt="...">
...
<div class="offcanvas offcanvas-end" id="modalShoppingCart" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <ul class="list-group list-group-lg list-group-flush">
        ...
        @if (session('shopping_cart'))
            @foreach(session('shopping_cart') as $obj)
                @php $total += $obj['product_price'] * $obj['product_quantity'] @endphp
                <li class="list-group-item">
                    <div class="row align-items-center">
                        <div class="col-4">

                            <!-- Image -->
                            <a href="/home/product/detail/{{$obj['id']}}">
                                <img class="img-fluid"src="/image/{{$obj['product_image']}}" alt="...">
                            </a>
                        ...
                        <div class="col-8">
                            ...
                            <p class="fs-sm fw-bold mb-6">
                                <a class="text-body" href="/home/product/detail/{{$obj['id']}}">{{$obj['product_name']}}</a> <br>
                                <span class="text-muted">{{$obj['product_price']}}</span>
                            </p>
                            {{--                            @dump(session('shopping_cart'))--}}

                            <!--Footer -->
                            <div class="d-flex align-items-center">

                                <div>
                                    Q.ty: {{$obj['product_quantity']}}
                                </div>

                                <!-- Remove -->
                                <form method="post">
                                    @csrf
                                    <a class="fs-xs text-gray-400 ms-auto cart_remove" type="submit" href='/home/cart/remove/{{$obj['id']}}'>
    ...
    <div class="offcanvas-footer justify-between lh-fixed fs-sm bg-light mt-auto">
        <strong>Total</strong> <strong class="ms-auto">{{$total}}</strong>
    </div>

    <!-- Buttons -->
    <div class="offcanvas-body">
        <a class="btn w-100 btn-dark" href="/home/checkout">Continue to Checkout</a>
        <a class="btn w-100 btn-outline-dark mt-2" href="/home/cart">View Cart</a>
    </div>
                ...
                <div class="collapse" id="sidebarHome" data-bs-parent="#sidebarNav">
                    <ul class="list-styled fs-lg py-3 mb-0">
                        ...
                        <li class="list-styled-item">
                            <a class="list-styled-link" href='/home/category/{{$obj->category_name}}'>{{$obj -> category_name}}</a>
                        </li>
                        @endforeach
                            <li class="list-styled-item">
                            <a class="list-styled-link" href="/home/product/all">All products</a>
                        </li>
            ...
            <div class="modal-body">
                <div class="row mb-6">
                    <div class="col-12 col-md-3">
                        ...
                        <!-- Image -->
                        <a href="product.html">
                            <img class="img-fluid mb-7 mb-md-0" src="shopper/assets/img/products/product-6.jpg" alt="...">
                        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
                        ...
                        <div class="card card-lg">
                            <div class="card-body">
                                <ul class="list-styled fs-sm">
                                    @foreach($category as $obj)
                                        <li class="list-styled-item">
                                            <a class="list-styled-link" href="/home/category/{{$obj->category_name}}">
                                                {{$obj->category_name}}
                                            </a>
                                        </li>
                                    @endforeach
                                    <li class="list-styled-item">
                                        <a class="list-styled-link" href="/home/product/all">
                                            All products
                                        </a>
                                    </li>
                                </ul>
            ...
            <ul class="navbar-nav flex-row">
                ...
                <li class="nav-item ms-lg-n4">
                    <a class="nav-link" href="/home/order/history">
                ...
                <li class="nav-item ms-lg-n4">
                    <a class ='nav-link' href="/auth/logout" style="color: red">LOG OUT</a>
                </li>
            </ul>
...
<section>
    <div class="row gx-0 d-block d-lg-flex flickity flickity-lg-none" data-flickity='{"watchCSS": true}'>
        ...
        <!-- Item -->
        <div class="col-12 col-md-6 col-lg-4 d-flex flex-column bg-cover" style="background-image: url(shopper/assets/img/covers/cover-1.jpg);">
            <div class="card bg-dark-5 bg-hover text-white text-center" style="min-height: 470px;">
                ...
                <div class="card-body mt-auto py-8">
                    ...
                    <!-- Button -->
                    <a class="btn btn-white stretched-link" href="/home/category/Switch">
                        Shop Switches <i class="fe fe-arrow-right ms-2"></i>
                    </a>
        ...
        <!-- Card -->
        <div class="col-12 col-md-6 col-lg-4 d-flex flex-column bg-cover" style="background-image: url(shopper/assets/img/covers/cover-2.jpg);">
            <div class="card bg-dark-5 bg-hover text-white text-center" style="min-height: 470px;">
                <div class="card-body mt-auto mb-n11 py-8">
                ...
                <div class="card-body mt-auto py-8">
                    ...
                    <!-- Button -->
                    <a class="btn btn-white stretched-link" href="/home/category/Kit">
                        Shop Kits <i class="fe fe-arrow-right ms-2"></i>
                    </a>
        ...
        <!-- Card -->
        <div class="col-12 col-md-6 col-lg-4 d-flex flex-column bg-cover" style="background-image: url(shopper/assets/img/covers/cover-3.jpg);">
            <div class="card bg-dark-5 bg-hover text-white text-center" style="min-height: 470px;">
                <div class="card-body mt-auto mb-n11 py-8">
                ...
                <div class="card-body mt-auto py-8">
                    ...
                    <!-- Button -->
                    <a class="btn btn-white stretched-link" href="/home/category/Keycap">
                        Shop Keycaps <i class="fe fe-arrow-right ms-2"></i>
                    </a>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-md-5 col-lg-4 d-flex flex-column">
                ...
                <!-- Card -->
                <div class="card mb-7 text-white" style="min-height: 400px; background-image: url(shopper/assets/img/products/product-1.jpg)">

                    <!-- Background -->
                    <div class="card-bg">
                        <div class="card-bg-img bg-cover" style="background-image: url(shopper/assets/img/products/product-1.jpg);"></div>
                    </div>
                    ...
                    <div class="card-body my-auto text-center">
                        ...
                        <!-- Heading -->
                        <h4 class="mb-0">Keycaps</h4>

                        <!-- Link -->
                        <a class="btn btn-link stretched-link text-reset" href="/home/category/Keycaps">
            ...
            <div class="col-12 col-md-7 col-lg-8 d-flex flex-column">
                ...
                <div class="card mb-7 text-body" style="min-height: 400px;">
                    ...
                    <!-- Background -->
                    <div class="card-bg">
                        <div class="card-bg-img bg-cover" style="background-image: url(shopper/assets/img/products/product-2.jpg);"></div>
                    </div>
                    ...
                    <div class="card-body my-auto px-md-10 text-center text-md-start">
                        ...
                        <!-- Heading -->
                        <h4 class="mb-0">Kit</h4>

                        <!-- Link -->
                        <a class="btn btn-link stretched-link px-0 text-reset" href="/home/category/Kit">
                            Shop Now <i class="fe fe-arrow-right ms-2"></i>
                        </a>
            ...
            <div class="col-12 col-md-7 col-lg-8 d-flex flex-column">
                ...
                <div class="card mb-7 mb-md-0 text-body" style="min-height: 400px;">
                    ...
                    <!-- Background -->
                    <div class="card-bg">
                        <div class="card-bg-img bg-cover" style="background-image: url(shopper/assets/img/products/product-3.jpg);"></div>
                    </div>
                    ...
                    <div class="card-body my-auto px-md-10 text-center text-md-start">
                        ...
                        <!-- Heading -->
                        <h4 class="mb-0">Switches</h4>

                        <!-- Link -->
                        <a class="btn btn-link stretched-link px-0 text-reset" href="home/category/Switch">
                            Shop Now <i class="fe fe-arrow-right ms-2"></i>
                        </a>
            ...
            <div class="col-12 col-md-5 col-lg-4 d-flex flex-column">
                ...
                <div class="card text-white" style="min-height: 400px;">
                    ...
                    <!-- Background -->
                    <div class="card-bg">
                        <div class="card-bg-img bg-cover" style="background-image: url(shopper/assets/img/products/product-4.jpg);"></div>
                    </div>
                    ...
                    <div class="card-body my-auto text-center">
                        ...
                        <!-- Link -->
                        <a class="btn btn-link stretched-link text-reset" href="/home/category/Tools">
                            Shop Now <i class="fe fe-arrow-right ms-2"></i>
                        </a>
...
<!-- COUNTDOWN -->
<section class="py-13 bg-cover mt-3" style="background-image: url(shopper/assets/img/covers/cover-4.jpg)">
    <div class="container">
        <div class="row justify-content-end">
            <div class="col-12 col-md-8 col-lg-6">
                ...
                <!-- Heading -->
                <h3 class="mb-7">
                    <span style="font-family: Arial" class="text-white font-weight-bold"><b><u>GIẢM NGAY 500K</u></b></span><br /><span class="text-white" style="font-family: Arial">khi đưa shop tờ voucher như hình</span>
                </h3>

                <!-- Counter -->
                <div class="d-flex mb-9" data-countdown data-date="Dec 31, 2025 00:00:00" >
                    <div class="text-center">
                        <div class="fs-1 fw-bolder text-warning" data-days>00</div>
                        <div class="heading-xxs text-warning">Days</div>
                    </div>
                    <div class="px-1 px-md-4">
                        <div class="fs-2 fw-bolder text-warning">:</div>
                    </div>
                    <div class="text-center">
                        <div class="fs-1 fw-bolder text-warning" data-hours>00</div>
                        <div class="heading-xxs text-warning">Hours</div>
                    </div>
                    <div class="px-1 px-md-4">
                        <div class="fs-2 fw-bolder text-warning">:</div>
                    </div>
                    <div class="text-center">
                        <div class="fs-1 fw-bolder text-warning" data-minutes>00</div>
                        <div class="heading-xxs text-warning">Minutes</div>
                    </div>
                    <div class="px-1 px-md-4">
                        <div class="fs-2 fw-bolder text-warning">:</div>
                    </div>
                    <div class="text-center">
                        <div class="fs-1 fw-bolder text-warning" data-seconds>00</div>
                        <div class="heading-xxs text-warning">Seconds</div>
                    </div>
                </div>

                <!-- Button -->
                <a class="btn btn-dark" href="/home/product/all" style="color: #ffe500">
                    Shop Now <i class="fe fe-arrow-right ms-2"></i>
                </a>
...
<!-- FOOTER -->
<footer class="bg-dark bg-cover " style="background-image: url(shopper/assets/img/patterns/pattern-2.svg)">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-md-3">
                    ...
                    <!-- Heading -->
                    <h4 class="mb-6 text-white">Phuong Keyboards.</h4>

                    <!-- Social -->
                    <ul class="list-unstyled list-inline mb-7 mb-md-0">
                        <li class="list-inline-item">
                            <a href="https://www.facebook.com/phuongnguyen.me/" class="text-gray-350">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a href="https://www.instagram.com/ndtp.phuong/" class="text-gray-350">
                                <i class="fab fa-instagram"></i>
                            </a>
                        </li>
                    </ul>
                ...
                <div class="col">
<div class="row">
    <iframe src="https://giphy.com/embed/ferYVfmvi2IN5indq1"  height="300" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>
</div>
                </div>
                <div class="col-6 col-sm">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li>
                            <a class="text-gray-300" href="tel:(+84)93 4516 636">CALL ME</a>
                        </li>
                        <br>
                        <li>
                            <a class="text-gray-300" href="mailto:trungphuongtxn@gmail.com">EMAIL ME</a>
                        </li>
                    </ul>
    ...
    <div class="py-6">
        <div class="container">
            <div class="row">
                ...
                <div class="col-auto">
                    <span style="color: #8bd450">NGUYEN DAC TRUNG PHUONG</span> - <span style="color: #a061ff;">PROJECT NO.2</span> - <span style="color: #8bd450;">2023</span>
                </div>
            </div>
        </div>
    </div>
...
<!-- Vendor JS -->
<script src="shopper/assets/js/vendor.bundle.js"></script>

<!-- Theme JS -->
<script src="shopper/assets/js/theme.bundle.js"></script>

</body>

<!-- Mirrored from yevgenysim-turkey.github.io/shopper/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Oct 2023 14:36:59 GMT -->
</html>
