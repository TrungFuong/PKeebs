...
<!-- Mirrored from yevgenysim-turkey.github.io/shopper/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Oct 2023 14:37:09 GMT -->
    ...
    <ul class="list-group list-group-lg list-group-flush">
        ...
        @if (session('shopping_cart'))
            @foreach(session('shopping_cart') as $obj)
                @php $total += $obj['product_price'] * $obj['quantity'] @endphp
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-md-7">
                ...
                <!-- Form -->
                <form action="/home/place_order" method="post">
                    @csrf
                    <!-- Heading -->
...
{{--                            @dump($obj)--}}
                        <div class="col-12">
                                ...
                                <input class="form-control form-control-sm" id="checkoutBillingLastName" type="text" value="{{$obj->name}}" name="customer_name" required>
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" id="checkoutBillingAddress" type="text" value="{{$obj->address}}" name="customer_address" required>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input class="form-control form-control-sm" id="checkoutBillingPhone" type="tel" value="{{$obj -> phone}}" name="customer_phone" required>
                            </div>
                    ...
                    <li class="list-group-item">
                        <div class="row align-items-center">
                            <div class="col-4">
                                ...
                                <!-- Image -->
                                <a href="/home/product/{{$obj['id']}}">
                                    <img src="/image/{{$obj['product_image']}}" alt="..." class="img-fluid">
                                </a>
                        ...
                        <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
                            <li class="list-group-item d-flex fs-lg fw-bold">
                                ...
                                @foreach(session('shopping_cart') as $obj)
                                    @php $total += ($obj['product_price'] * $obj['quantity']) @endphp
                                @endforeach
                                <span>Total</span> <span class="ms-auto" id="temp_total">{{$total}}</span>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-auto">
                    ...
                    <!-- Payment methods -->
                    <img class="footer-payment" src="/shopper/assets/img/payment/mastercard.svg" alt="...">
                    <img class="footer-payment" src="/shopper/assets/img/payment/visa.svg" alt="...">
                    <img class="footer-payment" src="/shopper/assets/img/payment/amex.svg" alt="...">
                    <img class="footer-payment" src="/shopper/assets/img/payment/paypal.svg" alt="...">
                    <img class="footer-payment" src="/shopper/assets/img/payment/maestro.svg" alt="...">
                    <img class="footer-payment" src="/shopper/assets/img/payment/klarna.svg" alt="...">
...
<script>
    document.addEventListener('DOMContentLoaded', function(){
        var temp_total = document.getElementById("temp_total").textContent;
        document.getElementById("total").value = temp_total;
    });
</script>

</body>

<!-- Mirrored from yevgenysim-turkey.github.io/shopper/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Oct 2023 14:37:10 GMT -->
</html>
