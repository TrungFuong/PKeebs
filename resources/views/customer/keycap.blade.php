                                ...
                                <div class="form-group form-group-overflow mb-6" id="seasonGroup">
                                    <div class="form-check mb-3">
                                        <ul>
                                            @foreach ($category as $obj)
                                                <li>
                                                    <a href='/home/category/{{$obj->category_name}}'>
                                                        {{$obj->category_name}}
                                                    </a>
                                                </li>
                                            @endforeach
                                        ...
                                        <div class="form-check mb-3">
                                            <ul>
                                                @foreach ($manufacturer as $obj)
                                                    <li>
                                                        <a href='/home/manufacturer/{{$obj->manufacturer_name}}'>
                        ...
                        <div class="col-6 col-md-4">
                            ...
                            <div class="card mb-7">
                                ...
                                <div class="card-img">
                                    ...
                                    <!-- Image -->
                                    <a class="card-img-hover" href='/home/product/detail/{{$obj->product_id}}'>
                                        <img style="height: 200px" class="card-img-top" src="/image/{{$obj -> product_image}}" alt="...">
                                    </a>
                                ...
                                <div class="card-body px-0">
                                    ...
                                    <!-- Category -->
                                    <div class="fs-xs">
                                        <a class="text-muted" href='/home/category/{{$obj->category->category_name}}'>{{$obj->category->category_name}}</a>
                                    </div>

                                    <!-- Title -->
                                    <div class="fw-bold">
                                        <a class="text-body" href="/home/product/detail/{{$obj->product_id}}">
                                            {{$obj->product_name}}
                                        </a>
                                    </div>
...
<!-- Mirrored from yevgenysim-turkey.github.io//shopper/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Oct 2023 14:37:09 GMT -->
</html>
