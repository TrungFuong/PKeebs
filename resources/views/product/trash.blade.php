    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Deleted roducts</h1>
                <div class="card mb-4" >
                    <div class="card-body">
                            ...
                            @foreach($product as $obj)
                                <tr>
                                    ...
                                    <td class="text-center justify-content-center">
                                        ...
                                        <a href="admin/product/delete-permanent/{{{$obj->id}}}" class="btn btn-delete btn-danger mt-2 mb-2" data-product-name = "{{$obj -> product_name}}">PERMANENT Delete</a>
                                        <a href="/admin/product/{{$obj->id}}" class="btn btn-warning mt-2 mb-2">View</a>
                                        <a href="/admin/product/restore/{{$obj->id}}" class="btn btn-success mt-2 mb-2">Restore</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
